...
namespace BLWSDAI.Migrations
{
    ...
    [Migration("20250517153611_UpdateConsumerUnique")]
    partial class UpdateConsumerUnique
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BLWSDAI.Models.Consumer", b =>
                {
                    ...
                    b.HasIndex("Email")
                        .IsUnique()
                        .HasDatabaseName("ix_consumers_email");
                    ...
                    b.HasIndex("PhoneNumber")
                        .IsUnique()
                        .HasDatabaseName("ix_consumers_phone_number");
